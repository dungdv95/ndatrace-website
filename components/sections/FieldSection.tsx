    ...
    return (
      <section id="field" className="flex flex-col gap-[39px]">
        <div className="relative flex justify-center min-h-[609px]">
          <div className="z-0 absolute top-[-58px] ">
        ...
        <div className="px-4 grid grid-cols-3 gap-4 max-[43.75rem]:grid-cols-2">
          <div className="animate-pulse bg-[#EFF8FF] px-2 py-1 rounded-[8px] flex gap-[8px] items-center">
            <div>
          ...
          <div className="animate-pulse bg-[#EFF4FF] px-2 py-1 rounded-[8px] flex gap-[8px] items-center">
            <div>
          ...
          <div className="animate-pulse bg-[#EDFCF2] px-2 py-1 rounded-[8px] flex gap-[8px] items-center">
            <div>
          ...
          <div className="animate-pulse bg-[#EEF4FF] px-2 py-1 rounded-[8px] flex gap-[8px] items-center">
            <div>
          ...
          <div className="animate-pulse bg-[#FEFBE8] px-2 py-1 rounded-[8px] flex gap-[8px] items-center">
            <div>
          ...
          <div className="animate-pulse bg-[#FFF4ED] px-2 py-1 rounded-[8px] flex gap-[8px] items-center">
            <div>
          ...
          <div className="col-start-2 max-[43.75rem]:gap-3 max-[43.75rem]:col-span-2 max-[43.75rem]:justify-self-center  animate-pulse bg-[#FEF3F2] px-2 py-1 rounded-[8px] flex gap-[8px] items-center">
            <div>
    ...
    <div id="field" className="pb-[68px] pt-[42px] flex justify-center">
      <div className="relative h-[811px] w-[811px]">
        <img
          ...
          className="object-cover h-full w-full"
        />
        <div className="z-10 absolute w-full flex justify-center top-[93px]">
        ...
        <div className="z-10 absolute top-[25%] left-[-44px]">
          <div className="animate-pulse bg-[#EFF8FF] px-2 py-1 rounded-[8px] flex gap-[10px] items-center">
            <div>
              <Icons.benefitMilk className="max-xl:w-10 max-xl:h-10" />
            </div>
        ...
        <div className="h-full absolute top-0 left-[-146px] flex items-center max-xl:left-[-105px]">
          <div className="animate-pulse bg-[#EDFCF2] px-2 py-1 rounded-[8px] flex gap-[10px] items-center">
            <div>
              <Icons.benefitFood className="max-xl:w-10 max-xl:h-10" />
            </div>
        ...
        <div className="absolute top-[75%] left-[51px]">
          <div className="animate-pulse bg-[#FEFBE8] px-2 py-1 rounded-[8px] flex gap-[10px] items-center">
            <div>
              <Icons.benefitDress className="max-xl:w-10 max-xl:h-10" />
            </div>
        ...
        <div className="absolute bottom-[86px] flex justify-center w-full">
          <div className="animate-pulse bg-[#FEF3F2] px-2 py-1 rounded-[8px] flex gap-[10px] items-center">
            <div>
              <Icons.benefitSetting className="max-xl:w-10 max-xl:h-10" />
            </div>
        ...
        <div className="absolute top-[75%] right-[-12px]">
          <div className="animate-pulse bg-[#FFF4ED] px-2 py-1 rounded-[8px] flex gap-[10px] items-center">
            <div>
              <Icons.benefitLogistic className="max-xl:w-10 max-xl:h-10" />
            </div>
        ...
        <div className="h-full absolute top-0 right-[-146px] flex items-center max-xl:right-[-105px]">
          <div className="animate-pulse bg-[#EEF4FF] px-2 py-1 rounded-[8px] flex gap-[10px] items-center">
            <div>
              <Icons.benefitDiamond className="max-xl:w-10 max-xl:h-10" />
            </div>
        ...
        <div className="absolute top-[25%] right-[-8px]">
          <div className="animate-pulse bg-[#EFF4FF] px-2 py-1 rounded-[8px] flex gap-[10px] items-center">
            <div>
              <Icons.benefitCosmetics className="max-xl:w-10 max-xl:h-10" />
            </div>
